 ...
 * functions.
 * Modified for I2C using MBED & Leapord Gecko Libs
 */
...
#if DEBUG_PRINT
	PC_Serial.printf("Setting interrupts: %d\r\n", interrupts);
#endif
...
#if DEBUG_PRINT
	PC_Serial.printf("Gesture read: %d", gesture);
#endif
	switch (gesture) {
	case RIGHT_SWIPE:
		return RIGHT_SWIPE;
